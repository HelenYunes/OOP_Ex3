...
start_time = time.time()
c = nx.single_source_dijkstra(from_json(file_name), 7, 1)
...
start_time = time.time()
c = nx.single_source_dijkstra(from_json(file_name), 844, 416)
print("--- %s seconds --- Networkx" % (time.time() - start_time))
print(c)
g_a.load_from_json(file_name)
start_time = time.time()
...
start_time = time.time()
c = nx.single_source_dijkstra(from_json(file_name), 6, 241)
print("--- %s seconds --- Networkx" % (time.time() - start_time))
print(c)
...
start_time = time.time()
c = nx.single_source_dijkstra(from_json(file_name), 0, 17033)
print("--- %s seconds --- Networkx" % (time.time() - start_time))
print(c)
...
start_time = time.time()
c = nx.single_source_dijkstra(from_json(file_name), 0, 5)
print("--- %s seconds --- Networkx" % (time.time() - start_time))
print(c)
...
file_name = '../data/G_10_80_1.json'
start_time = time.time()
c = list(nx.strongly_connected_components(from_json(file_name)))
print("--- %s seconds --- Networkx" % (time.time() - start_time))
print(c)
