...
file_name = 'Graphs_on_circle/G_10000_80000_1.json'
g_a.load_from_json(file_name)

print("this is the 10000_80000 graph shortest path comparison")

start_time = time.time()
c = nx.shortest_path(from_json(file_name),226,2797)
...
file_name = 'Graphs_on_circle/G_100_800_1.json'
start_time = time.time()
c = nx.shortest_path(from_json(file_name),7,1)
print("--- %s seconds --- Networkx" % (time.time() - start_time))
print(c)
...
file_name = 'Graphs_on_circle/G_1000_8000_1.json'
start_time = time.time()
c = nx.shortest_path(from_json(file_name),844,416)
print("--- %s seconds --- Networkx" % (time.time() - start_time))
print(c)
